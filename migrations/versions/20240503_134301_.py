...
Revision ID: 9b7f2c77ad2b
Revises: 
Create Date: 2024-05-03 13:43:01.544299
...
def upgrade():
    ...
    op.create_table('song_playlist_associations',
...
def downgrade():
    ...
    op.drop_table('song_playlist_associations')
    op.drop_table('likes')
    op.drop_table('songs')
